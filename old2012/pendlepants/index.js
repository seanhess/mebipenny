...
// Generated by CoffeeScript 1.3.3
var flatten, uniqueOutfits, without;
...
readReverseLines(function(lines) {
  var outfits, string, wardrobe;
  wardrobe = [];
  while ((string = readString(lines))) {
    wardrobe.push(string.split(" "));
  }
  outfits = uniqueOutfits(wardrobe);
  lines = outfits.map(function(outs) {
    return outs.join(" ");
  });
  return writeOutputs(lines);
});

uniqueOutfits = function(wardrobe) {
  var cloth, otherTypes, sub, subs, type, uniques, _i, _j, _len, _len1;
