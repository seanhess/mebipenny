...
// Generated by CoffeeScript 1.3.3
var closestPair, flatten, sortBy, toAnimal;
...
readReverseLines(function(lines) {
  var chickens, closest, goats, numChickens, numGoats, _ref;
  _ref = readLine(toInts, lines), numChickens = _ref[0], numGoats = _ref[1];
  chickens = readLines(lines, numChickens, toAnimal);
  goats = readLines(lines, numGoats, toAnimal);
  closest = closestPair(chickens, goats);
  return console.log(closest.one.id, closest.two.id);
});

toAnimal = toObject(["id", "x", "y"]);

closestPair = function(chickens, goats) {
  var chicken, distance, ds, dss, flat, goat, sorted;
  ...
  dss = (function() {
    ...
    _results = [];
    for (_i = 0, _len = chickens.length; _i < _len; _i++) {
      chicken = chickens[_i];
      _results.push(ds = (function() {
        var _j, _len1, _results1;
        _results1 = [];
        for (_j = 0, _len1 = goats.length; _j < _len1; _j++) {
          goat = goats[_j];
          _results1.push(distance(chicken, goat));
        }
        return _results1;
      })());
    }
  ...
  flat = flatten(dss);
  sorted = sortBy(flat, function(info) {
